...
El sistema integra herramientas modernas como `Request´, BeautifulSoup, Playwright, Pandas, Maatplotlib, y librerias para generación de reportes y envio de correos.
